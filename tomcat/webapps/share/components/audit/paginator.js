 ...
 */
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			firstArrow : (new Image()).src="/share/components/images/first.bmp",  
			prevArrow : (new Image()).src="/share/components/images/prev.bmp",
			lastArrow : (new Image()).src="/share/components/images/last.bmp",
			nextArrow : (new Image()).src="/share/components/images/next.bmp",
			rowsPerPage : 10,
			currPage : 1,
